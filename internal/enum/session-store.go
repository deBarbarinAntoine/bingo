...
// Generated at: 2026-04-03 21:56:11
...
var sessionStoreKeys = make(map[SessionStore]struct{}, 9)
var sessionStoreValues = make(map[string]SessionStore, 9)
var sessionStoreKeysArray = make([]SessionStore, 9)
var sessionStoreValuesArray = make([]string, 9)
...
func init() {
    ...
    sessionStoreKeys[valkey] = struct{}{}
    sessionStoreKeysArray[8] = valkey
    sessionStoreValues["valkeystore"] = valkey
    sessionStoreValuesArray[8] = "valkeystore"
}
